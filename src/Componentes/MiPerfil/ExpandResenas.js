...
import { Grid, Typography, Divider, IconButton, Paper } from '@material-ui/core';
...
export default function ExpandResenas(props) {
                ...
                <Grid item md={10} xs={10}>
                    <Grid container justify="center" alignItems="center">
                        <Grid item md={6} className={classes.arriba}>
                            <Typography component="h2" variant="h6" color="primary">Hotel Paihuen #1234567</Typography>
                        </Grid>
                        <Grid item md={6} className={classes.arriba}>
